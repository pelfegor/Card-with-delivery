# Card-with-delivery [![Build status](https://ci.appveyor.com/api/projects/status/sdlav2lbedj5aexc?svg=true)](https://ci.appveyor.com/project/pelfegor/card-with-delivery)
